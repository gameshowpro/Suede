...
## License of contributions, and why it is asked for

Suede is available under the [PolyForm Small Business License](LICENSE), and
separately under a commercial license for organizations the PolyForm license
...
could not be included in a commercial license — which would mean either
...
2. You grant Barjonas LLC a perpetual, worldwide, irrevocable, royalty-free
   ...
   contribution, under any license terms, including commercial ones.
...
offered under two licenses at once; point 3 means you lose nothing.
...
- Comments say *why*, not *what*. If a line needs explaining, it usually needs
  rewriting instead.
- Tests are named as sentences about behavior, not after the function they
  exercise.
