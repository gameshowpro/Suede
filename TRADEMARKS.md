...
- Say that your product, service or installation uses Suede, works with
...
- Naming a **modified** version "Suede", or naming it in a way a reasonable
  person would confuse with Suede. If you publish a fork, give it your own
  name. You may say it is derived from Suede.
- Using the name or logo in a way that suggests endorsement, affiliation, or
  official status.
- Using it in your company name, product name, domain name, app-store listing
...
Questions, or a request for permission: <https://barjonas.com/#contact>
