...
#[openapi(
    ...
    paths(
        ...
        super::observed::list_av_devices,
        super::observed::get_status,
        super::observed::get_projection_stats,
        super::projection::recommend_resolution,
        super::projection::get_arrangement,
        ...
        super::config_routes::delete_output_geometry,
        ...
        super::config_routes::delete_projection_canvas,
        super::config_routes::get_projection_arrangement,
        super::config_routes::put_projection_arrangement,
        super::config_routes::revert_config,
        super::events::stream,
    ...
    components(schemas(
        ...
        super::apps::LaunchPreview,
        super::apps::PreviewItem,
        super::capabilities::CapabilityOutcome,
        super::capabilities::LastMeasurement,
        crate::model::CapabilityReport,
        crate::model::CodecSupport,
        crate::model::RestartReason,
        crate::model::AudioSink,
        crate::model::AudioSource,
        crate::model::VideoSource,
        crate::model::AvDevices,
        ...
        crate::model::Check,
        crate::model::PowerVerb,
        super::observed::PowerRequest,
        super::observed::PowerOutcome,
        ...
        crate::model::ProjectionMode,
        crate::model::CanvasConfig,
        crate::model::CanvasRect,
        crate::model::OutputGeometry,
        crate::model::ProjectionGeometryStatus,
        crate::model::Arrangement,
        crate::model::ArrangementRequest,
        crate::model::ArrangementSolution,
        crate::model::ArrangedOutput,
        crate::model::UnusedCanvas,
        crate::model::Overhang,
        crate::model::AxisLimits,
        crate::model::ArrangementLimits,
        crate::model::ArrangeOffset,
        super::config_routes::ArrangementStatus,
        super::projection::ArrangementDryRun,
        super::projection::RecommendationResponse,
        super::projection::ScalePreset,
